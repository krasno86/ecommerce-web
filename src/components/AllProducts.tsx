...
function App() {
    ...
    return (
        ...
        <h1 className="text-3xl font-bold text-[var(--text-h)]">Our Store</h1>
    <p className="text-[var(--text)]">Backend API connection test</p>
    </header>
    ...
    {error && <p className="text-red-500 mb-4 font-semibold">{error}</p>}
        ...
        {products.length === 0 && !error && (
            <p className="text-[var(--text)]">No products found or the database is empty...</p>
        )}
        </div>
    );
    }
